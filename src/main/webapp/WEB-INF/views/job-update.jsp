...
<h2>Update the job for ${companyname}</h2>
	...
	<form:form action="${contextPath}/jobs/update.htm"
		...
		<table>
			...
			<tr>
				<td colspan="2"><input class = "btn btn-success" name ="option" type="submit" value="Update Job" /></td>
                                <td colspan="2"><input class = "btn btn-success" name ="option" type="submit" value="Delete Job" /></td>
			</tr>
		</table>
